...
module.exports = function ( _gulp, _plugins, _app ) {
	...
	return {
		...
		'isArray': function (obj) {
			...
			let bIs = ('array' === this.getType(obj));
		...
		'isBoolean': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('boolean' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isFunction': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('function' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isNotEmpty': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bNotEmpty = (!this.isEmpty(obj));
		...
		'isObject': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('object' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isOther': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('other' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isString': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('string' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isSymbol': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('symbol' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		},
		...
		'isUndefined': function (obj) {
			...
			// log.enter(METHOD, obj);
			let bIs = ('undefined' === this.getType(obj));
			// log.return(METHOD, bIs);
			return bIs;
		}
	}
