...
function _initGulpTasks() {
    ...
    app.logger.info('finished'.green + ' registered gulp tasks.');
}
...
function pages(callback) {
    return gulp.src(app.core.paths.src + '/pages/**/*.{html,hbs,handlebars}')
        .pipe(app.fn.app.requireModule('panini')({
            root: app.core.paths.src + '/pages/',
            layouts: app.core.paths.src + '/layouts/',
            pageLayouts: ['default'],
            partials: app.core.paths.src + '/partials/',
            data: app.core.paths.src + '/data/',
            helpers: app.core.paths.src + '/helpers/'
        }))
        .pipe(gulp.dest(app.core.paths.dist))
}

// Load updated HTML templates and partials into Panini
function resetPages(callback) {
